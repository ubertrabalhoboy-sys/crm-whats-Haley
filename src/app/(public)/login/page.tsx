    ...
    <div className="mx-auto flex min-h-screen w-full max-w-2xl items-center justify-center px-4 py-10">
      <div className="wa-card w-full overflow-hidden rounded-3xl shadow-xl shadow-emerald-900/10">
        <div className="border-b wa-divider bg-white/35 px-8 py-10 text-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">Entrar</h1>
          <p className="mt-2 text-sm text-slate-600">Acesse sua conta para continuar no CRM.</p>
        </div>

        <div className="p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-slate-900">Bem-vindo de volta</h2>
            <p className="mt-1 text-sm text-slate-600">Preencha seus dados para entrar.</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-600">
            Não tem conta?{" "}
            <Link href="/signup" className="font-semibold text-[#075E54] underline underline-offset-4 hover:opacity-85">
              Criar conta
            </Link>
          </p>
        </div>
