...
export default function SidebarChats({
  ...
  return (
    <aside className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded-2xl wa-glass wa-divider border shadow-[0_12px_30px_rgba(18,140,126,0.06)]">
      <div className="sticky top-0 z-[2] flex items-center gap-2.5 border-b wa-divider bg-white/35 p-3 backdrop-blur-xl">
        <div>
          <div className="text-sm font-black text-slate-900 tracking-[0.2px]">Conversas</div>
          ...
          {chats.map((c) => {
            ...
            return (
              <button
                ...
                className={`cursor-pointer rounded-[14px] border p-3 text-left transition ${
                  active
                    ? "border-[#128C7E]/30 bg-white/60 ring-1 ring-[#128C7E]/20 shadow-[0_10px_24px_rgba(18,140,126,0.10)]"
                    : "wa-card hover:shadow-[0_8px_20px_rgba(18,140,126,0.08)] hover:bg-white/60"
                }`}
              >
