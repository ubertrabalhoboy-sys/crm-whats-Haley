                    ...
                    stageChats.map((chat) => (
                      ...
                      >
                        ...
                        <div className="mb-4 flex items-start justify-between">
                          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-[#07a0c3] to-[#086788] text-sm font-black text-white shadow-md">
