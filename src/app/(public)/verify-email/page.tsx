  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-2xl items-center justify-center px-4 py-10">
      <div className="glass-panel glass-card w-full overflow-hidden rounded-3xl shadow-2xl shadow-black/40">
        ...
        {/* content */}
        <div className="p-8">
          <h2 className="text-2xl font-medium text-white">Confirmação necessária</h2>
          ...
          <button
            ...
            onClick={resend}
            disabled={loading}
            className="glass-button mt-6 w-full rounded-xl px-4 py-3 text-sm font-semibold text-white hover:bg-white/15 disabled:opacity-60"
          >
